...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.userService.buildUserResponse(user)];
                }
            });
        });
    };
    UserController.prototype.login = function (loginDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.login(loginDto)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.userService.buildUserResponse(user)];
                }
    ...
    UserController.prototype.currentUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('user', user);
                        return [4 /*yield*/, this.userService.buildUserResponse(user)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UserController.prototype.updateCurrentUser = function (currentUserId, updateUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.updateUser(currentUserId, updateUserDto)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, this.userService.buildUserResponse(user)];
                }
    ...
    ], UserController.prototype, "currentUser");
    __decorate([
        (0, common_1.Put)('user'),
        (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
